...
void init_array(int ni, int nj,
    ...
    DATA_TYPE POLYBENCH_2D(B,NI,NJ,ni+1,nj+1))
{
  int i, j;
...
int main(int argc, char** argv)
{
  ...
  POLYBENCH_2D_ARRAY_DECL(B,DATA_TYPE,NI,NJ,ni+1,nj+1);
#else
  DATA_TYPE alpha;
  DATA_TYPE beta;
  ...
  add_2D_row_checksum(ni+1, nj+1, POLYBENCH_ARRAY(B), ni, nj);
  add_2D_col_checksum(ni+1, nj+1, POLYBENCH_ARRAY(B), ni, nj);
#endif

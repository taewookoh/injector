...
injector: injector.o decoder.o manage_bp.o flipper.o regmap.o
	g++ -O3 -o $@ $^ -L$(DISTORM_DIR)/build/lib.linux-x86_64-2.6/distorm3 -ldistorm3

test: injector 
	./injector --type a --prog ./test/target --breakpoint 0x400b2f --target 900000 --after_bp_addr 0x$(AFTER_BP_ADDR) --org_inst_addr 0x$(ORG_INST_ADDR) --target_addr 0x$(TARGET_ADDR)
